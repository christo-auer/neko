...
(defn ref-adapter
  ...
  `create-view-fn` is a function of context and position. `update-view-fn` is a
  function of four arguments: element position, view to update, parent view
  container and the respective data element from the ref-type. `access-fn`
  argument is optional, it is called on the value of ref-type to get the list to
  be displayed."
  ...
  ([create-view-fn update-view-fn ref-type access-fn]
   ...
   (let [create-fn (fn [context position]
                     (or (safe-for-ui
                          (let [view (create-view-fn context position)]
